function error_terms = ErrorPoseRefinement(hidden_state, observations, landmarks, K)
% hidden_state is given by a [q' t' q' t'] so no landmark refinement
% where q is a quaternion, t is a translation
